...
6. Use the `openrct2.d.ts` TypeScript API declaration file for v0.4.6 and copy it to `./lib/` folder.
   - This file can usually be found in the [OpenRCT2 installation directory](#openrct2-installation-directory).
   - Alternatively you can download the file from Github [here](https://raw.githubusercontent.com/OpenRCT2/OpenRCT2/v0.4.6/distribution/openrct2.d.ts).
